...
def main():
    ...
    run_analysis(X, y, "Scenario 1A: vit spettrogramma, snr=0")

    # (B) all noise
    X, y = dataset_solo_vit_spec(df_vit_spec_noise)
    run_analysis(X, y, "Scenario 1B: vit spettrogramma, snr>0")
